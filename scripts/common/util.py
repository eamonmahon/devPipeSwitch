...
class RunRemoteRepo:
    ...
    def __enter__(self):
        os.system("ssh %s 'git clone --quiet --branch %s https://github.com/eamonmahon/devPipeSwitch.git'" % (self.server['id'], self.branch))
        return self
...
class RunDocker:
    ...
    def __enter__(self):
        ...
        self.run('git clone --quiet --branch %s https://github.com/eamonmahon/devPipeSwitch.git' % self.branch)
        return self
